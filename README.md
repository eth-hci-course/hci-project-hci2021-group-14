...
Since variant B turned out to be superior in time taken and SUS-score, and the result for the lostness factor was inconclusive, variant B seems to have preformed better overall.
